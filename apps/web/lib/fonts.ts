...
const notoSansSC = localFont({
  src: [
    { path: "../public/fonts/noto-sans-sc/NotoSansSC-Regular.ttf", weight: "400" },
    { path: "../public/fonts/noto-sans-sc/NotoSansSC-Bold.ttf", weight: "700" },
  ],
...
const notoSerifSC = localFont({
  src: [
    { path: "../public/fonts/noto-serif-sc/NotoSerifSC-Regular.ttf", weight: "400" },
    { path: "../public/fonts/noto-serif-sc/NotoSerifSC-Bold.ttf", weight: "700" },
  ],
