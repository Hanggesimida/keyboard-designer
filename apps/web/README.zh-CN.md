...
| 布局 ID | 说明 |
|---------|------|
| `ansi-60` | ANSI 60%（61 键） |
| `ansi-65` | ANSI 65%（68 键） |
| `ansi-75` | ANSI 75%（80 键） |
| `ansi-75-84` | ANSI 75% 加长功能行（84 键） |
| `ansi-tkl` | ANSI TKL（87 键） |
| `ansi-1800` | ANSI 1800（99 键） |
| `ansi-104` | ANSI 全尺寸（104 键） |
| `ansi-108` | ANSI 全尺寸 + 媒体键（108 键，默认） |
| `ansi-108-kit` | 全尺寸 108 + 增补键帽（144） |
