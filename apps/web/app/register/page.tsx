    ...
    <div className="min-h-screen bg-[#0d0d0d] text-white flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, rgba(52,211,153,0.6) 0%, rgba(60,130,255,0.3) 50%, transparent 70%)",
            filter: "blur(80px)",
          }}
        />
        <div
          className="absolute bottom-1/3 left-1/4 w-[250px] h-[250px] rounded-full opacity-[0.08]"
          style={{
            background:
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(52,211,153,0.18) 0%, transparent 50%, rgba(60,130,255,0.1) 100%)",
          }}
        />
