...
export default function ProfileKeyboardsPage() {
  const t = useTranslations("Profile.keyboards")
  ...
  function handleConfirmDelete() {
    ...
    deleteDesign(id, {
      onError: (err) => {
        setErrorMessage(resolveErrorMessage(err, t("deleteFailed"), tErrors("sessionExpired")))
      },
    })
  }
      ...
      <ProfileSection>
        {isLoading ? (
          ...
          <ProfileEmptyState
            ...
            action={{ label: tHome("start"), href: "/design" }}
          />
        ) : (
